...
test.py::test_missing_file PASSED                                             [ 37%]
test.py::test_bad_file PASSED                                                 [ 50%]
test.py::test_amigo PASSED                                                    [ 62%]
test.py::test_tair PASSED                                                     [ 75%]
test.py::test_two_files PASSED                                                [ 87%]
test.py::test_repeat_seq PASSED                                               [100%]
